...
namespace Metrics {
	...
	extern TimeSeries<Eigen::Vector3d> posOffset_rawComputed;
	extern TimeSeries<Eigen::Vector3d> posOffset_currentCal;
	extern TimeSeries<Eigen::Vector3d> posOffset_lastSample;
